...
<select style="width:125px;background-color:white;color:grey"id="period" name="period" onchange="choose()">
...
<div style="margin-top:20px;font-size:26px;"><span style="background-color:white;border-radius:6px;margin:5px;color:orange" id="result"></span></div>
</div>
